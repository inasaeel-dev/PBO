...
public class Bike {
    ...
    public void setBrand (String brandName){ //method set brand untuk menetapkan nama merk
    ...
    public int speedAcceleration (int increment){ //menambah kecepatan sesuai batas gigi
        speed += increment;
    ...
    public int speedDeceleration (int decrement){ // menurunkan atau memperlambat kecepatan
        speed -= decrement; //
        if (speed < 0){
            speed = 0;
        }
